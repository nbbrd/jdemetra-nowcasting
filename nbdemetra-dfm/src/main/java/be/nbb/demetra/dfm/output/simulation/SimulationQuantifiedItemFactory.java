 ...
 * @author Mats Maggi
 */
@ServiceProvider(service = ProcDocumentItemFactory.class, position = 400300)
public class SimulationQuantifiedItemFactory extends DfmSimulationResultsItemFactory {
    public SimulationQuantifiedItemFactory() {
    ...
    private static ItemUI<IProcDocumentView<DfmDocument>, Optional<DfmSimulation>> newItemUI() {
        return new DefaultItemUI<IProcDocumentView<DfmDocument>, Optional<DfmSimulation>>() {
            ...
            public JComponent getView(IProcDocumentView<DfmDocument> host, Optional<DfmSimulation> information) {
                SimulationQuantifiedResultsView result = new SimulationQuantifiedResultsView(host.getDocument());

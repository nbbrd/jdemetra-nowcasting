...
public abstract class DfmNewsItemFactory extends ComposedProcDocumentItemFactory<VersionedDfmDocument, Optional<DfmNews>> {
    ...
    protected static enum Updates {
        ...
        NONE, NEWS, REVISIONS, NEWS_REVISIONS
    }
    ...
    private static final class DfmNewsExtractor extends DocumentInformationExtractor<VersionedDfmDocument, Optional<DfmNews>> {
        ...
        private static final DfmNewsExtractor NEWS_REV_INSTANCE = new DfmNewsExtractor(Updates.NEWS_REVISIONS);
        ...
        protected Optional<DfmNews> buildInfo(VersionedDfmDocument source) {
            switch (updt) {
                case REVISIONS:
                    return Optional.fromNullable(source.getRevisionsNews(-1));
                case NEWS_REVISIONS:
                    return Optional.fromNullable(source.getNewsAndRevisions(-1));
                default:
                    return Optional.fromNullable(source.getNews(-1));
            }

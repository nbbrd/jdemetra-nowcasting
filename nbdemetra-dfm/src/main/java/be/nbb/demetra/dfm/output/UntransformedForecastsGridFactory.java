 ...
 * @author Jean Palate
 */
@ServiceProvider(service = ProcDocumentItemFactory.class, position = 200332)
public class UntransformedForecastsGridFactory extends DfmDocumentItemFactory {

    public UntransformedForecastsGridFactory() {
        super(newId(), newItemUI());
    }

    private static Id newId() {
        return new LinearId("Forecasts", "Untransformed data");
    }
    ...
    private static ItemUI<IProcDocumentView<DfmDocument>, Optional<CompositeResults>> newItemUI() {
        return new DefaultItemUI<IProcDocumentView<DfmDocument>, Optional<CompositeResults>>() {
            ...
            public JComponent getView(IProcDocumentView<DfmDocument> host, Optional<CompositeResults> information) {
                ...
                String prefix=InformationSet.item(DfmProcessingFactory.FINALC, "var");
